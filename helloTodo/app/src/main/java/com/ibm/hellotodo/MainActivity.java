...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            client.initialize(this, "http://mikehantestv1.au-syd.mybluemix.net/", "afaef9e0-03f1-4d1a-833e-86a3d3b678c0");
    ...
    private void loadList() {
        ...
        request.send(getApplicationContext(), new ResponseListener() {
            ...
            public void onFailure(Response response, Throwable throwable, JSONObject jsonObject) {
                ...
                IgawAdbrix.retention("LOAD_LIST_ERROR!!!!!!");
            }
        });
    }
                ...
                if (!name.isEmpty()) {
                    ...
                    request.send(getApplicationContext(), json, new ResponseListener() {
                        ...
                        public void onSuccess(Response response) {
                            ...
                            IgawAdbrix.retention("your activity name");
                        ...
                        public void onFailure(Response response, Throwable t, JSONObject extendedInfo) {
                            ...
                            IgawAdbrix.firstTimeExperience("ADD_TO_DO_ITEM_ERRORrrrrrrrrR");
                ...
                if (!newName.isEmpty()) {
                    ...
                    request.send(getApplicationContext(), json, new ResponseListener() {
                        ...
                        public void onSuccess(Response response) {
                            ...
                            IgawAdbrix.retention("EditToDoItem");
                            loadList();
                        }
    ...
    public void isDoneToggle(View view) {
        ...
        request.send(getApplicationContext(), json, new ResponseListener() {
            ...
            public void onSuccess(Response response) {
                ...
                IgawAdbrix.retention("doneToDoItem");
